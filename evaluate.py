"""
evaluate.py
Phase 4: Evaluation Pipeline for OV-RAG vs Plain RAG
...
F1, correction success rate, hard-reject rate, and per-clash-type breakdown.

Ground truth is loaded from contract_ground_truth.json (generated by
...
class EvaluationRunner:
    ...
    def run(self):
        ...
        self._save_outputs(all_results, metrics, clash_metrics)
    ...
    def _compute_metrics(self, results: List[dict]) -> dict:
        """Compute confusion matrix and derived metrics for OV-RAG condition."""
        ovrag_results = [
            r for r in results
        ...
        return {
            ...
            "total_plain_queries": len([r for r in results if r.get("condition") == "plain"]),
    ...
    def _save_outputs(self, results: List[dict], metrics: dict, clash_metrics: dict):
